...
def paddle_one_up():
     y = paddle_one.ycor()         #getting the y coordinate
     y += 20
     if y <= 240:
          paddle_one.sety(y)
...
def paddle_two_up():
     y = paddle_two.ycor()         #getting the y coordinate
     y += 20
     if y <= 240:
          paddle_two.sety(y)
...
window.onkeypress(paddle_one_up, "a")
window.onkeypress(paddle_one_down, "z")
